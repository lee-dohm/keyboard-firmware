...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox(KC_GRAVE,KC_1,KC_2,KC_3,KC_4,KC_5,KC_ESCAPE,KC_TAB,KC_QUOTE,KC_COMMA,KC_DOT,KC_P,KC_Y,KC_LBRACKET,KC_BSLASH,KC_A,KC_O,KC_E,KC_U,KC_I,KC_LSHIFT,KC_SCOLON,KC_Q,KC_J,KC_K,KC_X,MO(1),ALL_T(KC_NO),KC_BSLASH,KC_LCTRL,KC_LALT,KC_LGUI,KC_HOME,KC_END,KC_PGUP,KC_BSPACE,KC_DELETE,KC_PGDOWN,TG(2),KC_6,KC_7,KC_8,KC_9,KC_0,KC_EQUAL,KC_RBRACKET,KC_F,KC_G,KC_C,KC_R,KC_L,KC_SLASH,KC_D,KC_H,KC_T,KC_N,KC_S,KC_MINUS,MO(1),KC_B,KC_M,KC_W,KC_V,KC_Z,KC_RSHIFT,KC_LEFT,KC_DOWN,KC_UP,KC_RIGHT,ALL_T(KC_NO),KC_AUDIO_VOL_UP,KC_MEDIA_PLAY_PAUSE,KC_AUDIO_VOL_DOWN,KC_AUDIO_MUTE,KC_ENTER,KC_SPACE),
